...
def get_style_configs() -> Dict[str, Dict[str, Any]]:
    ...
    default_configs = {
        ...
        'художественный': {'lexical_diversity': 0.8, 'formality': 0.3, 'readability': 70.0},
        'официально-деловой': {'lexical_diversity': 0.6, 'formality': 0.9, 'readability': 30.0},
        'разговорный': {'lexical_diversity': 0.5, 'formality': 0.2, 'readability': 80.0},
    }
    ...
    for style_name, style_config in style_configs.items():
        full_configs[style_name] = {
            'description': descriptions.get(style_name, f'{style_name.capitalize()} стиль'),
            'target_metrics': {
                'lexical_diversity': {
